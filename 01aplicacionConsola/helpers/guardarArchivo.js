...
export const guardarDB = ( data )=>{
    ...
    fs.writeFileSync(archivo, JSON.stringify(data)) // debo parsear la data a string para poder guardarla
}
...
export const leerDB =()=>{ 
    ...
    const info = fs.readFileSync(archivo,{encoding: 'utf-8'})//esto daría error si el archivo no existiera por eso la verificación con el if de antes
        ...
        //tengo que parsear info a JSON porque me devuelve un string 
